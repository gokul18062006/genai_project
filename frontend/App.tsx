            ...
            <main className="container mx-auto p-4 md:p-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
                        <div className="rounded-xl bg-white/80 border border-slate-200 px-4 py-3 text-sm text-slate-600">1. Add your legal document</div>
                        <div className="rounded-xl bg-white/80 border border-slate-200 px-4 py-3 text-sm text-slate-600">2. Review risks and details</div>
                        <div className="rounded-xl bg-white/80 border border-slate-200 px-4 py-3 text-sm text-slate-600">3. Ask follow-up questions in chat</div>
                    </div>
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                        ...
                        <div className="lg:col-span-2 flex flex-col gap-8">
                            {isLoading && (
                                <div className="w-full h-full flex flex-col items-center justify-center bg-white rounded-2xl shadow-sm border border-slate-200 p-8 min-h-[420px] text-center">
                            ...
                            {!isLoading && !analysisResult && (
                                <div className="w-full h-full flex flex-col justify-center bg-white rounded-2xl shadow-sm p-8 min-h-[420px] border border-slate-200">
                                    <div className="inline-flex items-center gap-2 self-start rounded-full bg-indigo-50 border border-indigo-100 px-3 py-1 text-xs font-semibold text-indigo-700">
                                        <Icon name="sparkles" className="h-4 w-4" />
                                        Smart legal assistant
                                    </div>
                                    <h3 className="mt-4 text-2xl md:text-3xl font-bold text-slate-800">Get instant legal clarity</h3>
